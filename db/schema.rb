...
ActiveRecord::Schema.define(version: 20161016191440) do
  ...
  create_table "client_social_stats", force: :cascade do |t|
    t.integer  "client_id",  limit: 4
    t.integer  "twitter",    limit: 4, default: 0, null: false
    t.integer  "instagram",  limit: 4, default: 0, null: false
    t.integer  "youtube",    limit: 4, default: 0, null: false
    t.datetime "created_at",                       null: false
    t.datetime "updated_at",                       null: false
  end

  add_index "client_social_stats", ["client_id"], name: "index_client_social_stats_on_client_id", using: :btree
  ...
  create_table "social_media_videos", force: :cascade do |t|
    t.string   "video_id",   limit: 255,             null: false
  ...
  add_foreign_key "client_social_stats", "clients"
