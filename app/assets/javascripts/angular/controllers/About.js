    ...
    constructor() {
        this.staff = {
            losAngeles: [
                ...
                { name: 'David', title: 'Agent', img: 'https://upload.wikimedia.org/wikipedia/commons/3/38/Two_dancers.jpg' },
                { name: 'Receptionist', title: 'Receptionist', img: 'https://upload.wikimedia.org/wikipedia/commons/3/38/Two_dancers.jpg' },
                { name: 'Chloe', title: 'Agent', img: 'https://upload.wikimedia.org/wikipedia/commons/3/38/Two_dancers.jpg' }
            ],
            newYork: [
                { name: 'Julie McDonald', title: 'Founder/Sr. Agent', img: 'http://www.msaagency.com/images/staff/74858411100511.jpg' },
                { name: 'Tony Selznick', title: 'Founder/Sr. Agent', img: 'http://dancemogul.com/news/wp-content/uploads/2013/02/tony.jpg' },
                { name: 'JC Gutierrez', title: 'Los Angeles and New York Director/Sr. Agent', img: 'https://upload.wikimedia.org/wikipedia/commons/3/38/Two_dancers.jpg' },
                { name: 'Bre O\'toole', title: 'Associate Director', img: 'https://upload.wikimedia.org/wikipedia/commons/3/38/Two_dancers.jpg' },
                { name: 'Rebecca Harrell', title: 'Assistant', img: 'https://upload.wikimedia.org/wikipedia/commons/3/38/Two_dancers.jpg' },
                { name: 'Nikki Della Penta', title: 'Agent', img: 'https://upload.wikimedia.org/wikipedia/commons/3/38/Two_dancers.jpg' }
            ]
        };
    }
}
